...
public class _06_Maps_Methods {
    public static void main(String[] args) {
        ...
        System.out.println(capitals.getOrDefault("Belgium", "Does not exist"));// we may override null
        ...
        System.out.println(capitals.replace("Ukraine", "Kyiv")); // null because nothing is replased
